...
import com.androidatc.materialdesign.activities.MainActivity;
import com.androidatc.materialdesign.adapters.AdapterDrawer;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mRecyclerDrawer.addOnItemTouchListener(new RecyclerTouchListener(getActivity(), mRecyclerDrawer, new ClickListener() {
            ...
            public void onClick(View view, int position) {
                ...
                //Al dar click sobre uno de los items del RecyclerView del drawer le pasamos
                //al MainActivity la posicion del item clickeado. De esa manera el cambio
                //se realiza en el MainActivity.
                //Le pasamos -1 para que funcione con el header
