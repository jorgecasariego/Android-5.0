    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        programFab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(FloatingMenuActivity.this, programFab1.getLabelText(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        menu2.setOnMenuToggleListener(new FloatingActionMenu.OnMenuToggleListener() {
            ...
            public void onMenuToggle(boolean opened) {
                ...
                Toast.makeText(FloatingMenuActivity.this, text, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        findViewById(R.id.fab_edit).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FloatingMenuActivity.this, RecyclerViewActivity.class));
            }
        });
